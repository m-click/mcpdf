...
2. [[https://oss.sonatype.org/content/repositories/releases/aero/m-click/mcpdf/0.2.2/mcpdf-0.2.2-jar-with-dependencies.jar][Download]] the latest standalone version
...
3. For the sake of brevity,
   ...
   #+BEGIN_SRC sh
   ln -s mcpdf-0.2.2-jar-with-dependencies.jar mcpdf.jar
   #+END_SRC
...
1. [[https://oss.sonatype.org/content/repositories/releases/aero/m-click/mcpdf/0.2.2/mcpdf-0.2.2.jar][Download]] the plain JAR file (mcpdf-0.2.2.jar)
...
3. Run both in combination:
   ...
   #+BEGIN_SRC sh
   java -cp itextpdf-X.Y.Z.jar:mcpdf-0.2.2.jar aero.m_click.mcpdf.Main
   #+END_SRC
