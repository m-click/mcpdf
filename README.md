...
Or - with fdf format data:

    java -jar mcpdf.jar FORM.pdf fill_form - output - flatten < DATA.fdf > RESULT.pdf

Note fill_form checks the header of the x/fdf file to determine whether to treat it as xfdf or fdf.
