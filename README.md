...
[Download](https://oss.sonatype.org/content/repositories/releases/aero/m-click/mcpdf/0.2.5/mcpdf-0.2.5-jar-with-dependencies.jar) the latest standalone version of Mcpdf (jar-with-dependencies).

For the sake of brevity, we will refer to this file as `mcpdf.jar`. So you should either rename the file or create a symlink:

    ln -s mcpdf-0.2.5-jar-with-dependencies.jar mcpdf.jar
...
[Download](https://oss.sonatype.org/content/repositories/releases/aero/m-click/mcpdf/0.2.5/mcpdf-0.2.5.jar) the plain JAR file (`mcpdf-0.2.5.jar`) instead of the jar-with-dependencies.
...
Run both in combination:
    ...
    java -cp itextpdf-X.Y.Z.jar:mcpdf-0.2.5.jar aero.m_click.mcpdf.Main
